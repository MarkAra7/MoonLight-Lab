...
<body>
    <div class="container">
        ...
        <p>Please verify your email address to create and play your own quizzes. This verification is required to unlock all features.</p>
        <a href="{{ $url }}" class="btn">Verify Email</a>
        <div class="footer">
            <p>This verification link expires in {{ $expireMinutes }} minutes.</p>
            <p style="margin-top: 8px;">If you did not create an account, no further action is required.</p>
        </div>
    </div>
</body>
</html>
